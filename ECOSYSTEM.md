...
# Logs
enclii logs nuit-one-api --env prod -f                    # live tail
enclii logs nuit-one-api --env prod --since 1h -n 200     # last hour
...
# Rollback
enclii rollback nuit-one-api --env prod                   # previous release
enclii rollback nuit-one-api v42 --env prod

# Releases + deployment history
enclii releases nuit-one-api -n 20
...
enclii domains list --service nuit-one-api
enclii domains add my.example.com --service nuit-one-api   # auto-provisions tunnel route + DNS
